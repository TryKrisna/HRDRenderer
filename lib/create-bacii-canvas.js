...
export function registerFonts() {
    GlobalFonts.loadFontsFromDir(path.join(process.cwd(), 'assets', 'MoEYS', 'fonts'));
}

export async function createTemplateImage() {
    const templatePath = path.join(process.cwd(), 'assets', 'MoEYS', 'certificate-bacii-stamp.png');
